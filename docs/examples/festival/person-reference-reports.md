...
```bash
nestql --cache docs/examples/festival/festival-dataset.json
```
...
```bash
nestql docs/examples/festival/person-resource-chart.nql
```
...
```bash
nestql docs/examples/festival/person-festival-summary.nql
```
...
```bash
nestql docs/examples/festival/person-work-chart.nql
nestql docs/examples/festival/person-work-chart.nql personId=PER004
```
