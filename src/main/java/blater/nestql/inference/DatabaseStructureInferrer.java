...
public final class DatabaseStructureInferrer {
  ...
  public DatabaseStructure infer(Connection connection) throws SQLException {
  ...
  private List<DatabaseStructure.Column> columns(
  ...
  private List<DatabaseStructure.CandidateKey> primaryKeys(
      DatabaseMetaData metadata,
      DatabaseStructure.RelationId relation) throws SQLException {
  ...
  private List<DatabaseStructure.CandidateKey> uniqueIndexes(
      DatabaseMetaData metadata,
      DatabaseStructure.RelationId relation) throws SQLException {
  ...
  private List<DatabaseStructure.Relationship> declaredRelationships(
      DatabaseMetaData metadata,
